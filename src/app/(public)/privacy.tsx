          ...
          >
            ...
            <View className="mb-6 ml-4">
              <Text className="text-base text-secondary leading-6">
                • <Text className="font-semibold">Account Information:</Text>{" "}
                Name, email address, phone number, user ID, and vehicle number
                when you create an account{"\n"}•{" "}
                <Text className="font-semibold">Location Data:</Text> Precise
                GPS coordinates from your device (both foreground and
                background){"\n"}•{" "}
                <Text className="font-semibold">Device Information:</Text>{" "}
                Device type, operating system, and app version{"\n"}•{" "}
                <Text className="font-semibold">Usage Data:</Text> Delivery
                statistics, performance metrics, and app interaction data
              </Text>
            </View>
            ...
            <View className="mb-6 ml-4">
              <Text className="text-base text-secondary leading-6">
                • <Text className="font-semibold">Account Management:</Text> To
                create and maintain your user profile, authenticate your
                identity, and provide personalized services{"\n"}•{" "}
                <Text className="font-semibold">Service Delivery:</Text> To
                enable core app functionality including delivery tracking, route
                optimization, and fleet management{"\n"}•{" "}
                <Text className="font-semibold">Performance Monitoring:</Text>{" "}
                To track your delivery statistics, completed deliveries, and
                ongoing assignments{"\n"}•{" "}
                <Text className="font-semibold">Communication:</Text> To send
                you important updates, notifications about deliveries, and
                service-related announcements{"\n"}•{" "}
                <Text className="font-semibold">Security:</Text> To protect your
                account, prevent fraud, and ensure the safety of our platform
              </Text>
            </View>
            ...
            <View className="mb-6 ml-4">
              <Text className="text-base text-secondary leading-6">
                • <Text className="font-semibold">Real-Time Tracking:</Text> We
                collect your GPS location continuously (every 10 seconds when
                moving 50+ meters) to show your current position to fleet
                managers and customers{"\n"}•{" "}
                <Text className="font-semibold">Foreground Location:</Text>{" "}
                High-accuracy location updates when the app is open, used for
                active delivery navigation and route tracking{"\n"}•{" "}
                <Text className="font-semibold">Background Location:</Text>{" "}
                Continuous tracking even when the app is closed or minimized,
                essential for monitoring delivery progress and ensuring driver
                safety{"\n"}•{" "}
                <Text className="font-semibold">Route Optimization:</Text>{" "}
                Historical location data helps optimize delivery routes and
                improve efficiency{"\n"}•{" "}
                <Text className="font-semibold">Delivery Verification:</Text>{" "}
                Location data confirms delivery completion at the correct
                address{"\n\n"}
                <Text className="font-semibold italic">Important:</Text> Without
                location permissions, the app cannot function properly. You will
                be prompted to enable location services if they are turned off.
                Background location tracking runs as a foreground service with a
            ...
            <View className="mb-6 ml-4">
              <Text className="text-base text-secondary leading-6">
                • Display your real-time location on the fleet management
                dashboard{"\n"}• Calculate accurate ETAs for deliveries{"\n"}•
                Generate performance reports and delivery statistics{"\n"}• Send
                push notifications about new assignments and delivery updates
                {"\n"}• Provide customer support and resolve delivery issues
                {"\n"}• Improve our services through analytics and usage
                patterns
              </Text>
            </View>
            ...
            <View className="mb-6 ml-4">
              <Text className="text-base text-secondary leading-6">
                • <Text className="font-semibold">Fleet Managers:</Text> Your
                location, delivery status, and performance metrics are visible
                to authorized fleet administrators{"\n"}•{" "}
                <Text className="font-semibold">Customers:</Text> Limited
                delivery tracking information (current location and ETA) may be
                shared with recipients{"\n"}•{" "}
                <Text className="font-semibold">Service Providers:</Text>{" "}
                Third-party services that help us operate the app (cloud
                hosting, analytics, notifications){"\n"}•{" "}
            ...
            <View className="mb-6 ml-4">
              <Text className="text-base text-secondary leading-6">
                • <Text className="font-semibold">Access:</Text> Request a copy
                of the personal data we hold about you{"\n"}•{" "}
                <Text className="font-semibold">Correction:</Text> Update or
                correct your account information at any time{"\n"}•{" "}
                <Text className="font-semibold">Deletion:</Text> Request
                complete deletion of your account and all associated data{"\n"}•{" "}
                <Text className="font-semibold">Opt-Out:</Text> Disable location
                tracking (note: this will prevent app functionality){"\n\n"}
                <Text className="font-semibold">
                  To Delete Your Account & Data:{"\n"}
                </Text>
                1. Open the Track Fleet Pro app{"\n"}
                2. Navigate to the{" "}
                <Text className="font-semibold">Profile</Text> tab (bottom
                navigation){"\n"}
                ...
                This action is{" "}
                <Text className="font-semibold">irreversible</Text> and will
                permanently delete all your data, including delivery history,
                performance stats, and account information.
              </Text>
            </View>
            ...
            <View className="mt-8 pt-6 border-t border-gray-100">
              <Text className="text-sm text-secondary text-center">
                ...
                Protection Officer at privacy@trackfleet.com
              </Text>
            </View>
          </View>
        </ScrollView>
